# Plan d'action — archive (historique déplacé de plan.md le 04/08/2026)

Ce fichier archive, SANS RIEN SUPPRIMER, l'historique de `plan.md`
(lot C de la synthèse des revues du 03/08/2026, P1) : chantiers terminés,
migrés et publiés, états de la base datés, décisions et étapes d'origine.
Les « RESTE » encore vivants ont été reportés dans `plan.md` (liste unique
des tests appareils, en-attente, backlog) AVANT le déplacement.
La passation vivante est dans `plan.md` ; le journal des passages de tests
est au cahier (`docs/technique/cahier-de-tests.md`).
...
## Items « réglés » purgés du suivi des cas d'utilisation (04/08/2026, P5)
...
- Détail des fractions du 08/07 (parseIngredientLine : « ½ », « 1/2 »,
